...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_TMP116_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COMMON_LIBC_MALLOC_ARENA_SIZE, 30000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_THREAD_STACK_SIZE, 5200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_WQ_STACK_SIZE, 4400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_MGMT_EVENT_STACK_SIZE, 4400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_SR_COEX_RF_SWITCH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_PCB_LOSS_2G, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_PCB_LOSS_5G_BAND1, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_PCB_LOSS_5G_BAND2, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_PCB_LOSS_5G_BAND3, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_WIFI_RPU_RECOVERY_PROPAGATION_DELAY_MS, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TMP116, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STA_SAMPLE_START_WIFI_THREAD_STACK_SIZE, 4096);
